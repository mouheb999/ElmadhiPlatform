...
/**
 * Down to a sensible number of points for an SVG 320px wide. The first and
 * last weeks always survive — they are the two the reader reads.
 */
export function sampleCurve(points: ProjectionPoint[], max = 26): ProjectionPoint[] {
